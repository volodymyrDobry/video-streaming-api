...
public class FileController implements StreamingApi {

    private final GetMovieUseCase getMovieUseCase;

    public ResponseEntity<Resource> getPlaylist(Long id) {
    ...
    public ResponseEntity<Resource> getSegment(Long id, Long segment) {
